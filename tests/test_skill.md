...
3. 浏览现有 acceptance：
   ...
   - [acceptance/language/test_surface_syntax.py](acceptance/language/test_surface_syntax.py)
   - [acceptance/language/test_casts.py](acceptance/language/test_casts.py)
   - [acceptance/language/test_sizeof_and_literals.py](acceptance/language/test_sizeof_and_literals.py)
   - [acceptance/language/test_strings_and_null.py](acceptance/language/test_strings_and_null.py)
   - [acceptance/language/test_const_qualification.py](acceptance/language/test_const_qualification.py)
   - [acceptance/language/test_aggregate_types.py](acceptance/language/test_aggregate_types.py)
   - [acceptance/language/test_struct_construction.py](acceptance/language/test_struct_construction.py)
   - [acceptance/language/test_functions.py](acceptance/language/test_functions.py)
   - [acceptance/language/test_references.py](acceptance/language/test_references.py)
   - [acceptance/language/test_operators.py](acceptance/language/test_operators.py)
   - [acceptance/modules/test_modules.py](acceptance/modules/test_modules.py)
   - [acceptance/toolchain/test_frontend.py](acceptance/toolchain/test_frontend.py)
   - [acceptance/diagnostics/test_diagnostics.py](acceptance/diagnostics/test_diagnostics.py)
4. 按需要再读：
